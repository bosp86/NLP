...
public class ExtractorExample {
        ...
        links.forEach(x -> {
            ...
            try {
                ...
                for (Element article : articleLinks) {
                    ...
                    if (article.text().matches("^.*?(Java 8|java 8|Html).*$")) {
                        //Remove the comment from the line below if you want to see it running on your editor, 
    ...
    public void writeToFile(String filename) {
        ...
        try {
            ...
            System.out.println("************* For each articles " + articles.size());
            articles.forEach(a -> {
                try {
            ...
            System.out.println("After For each articles");
            writer.close();
        } catch (IOException e) {
            System.err.println(e.getMessage());
        }
    ...
    public static void main(String[] args) {
        ...
        bwc.getArticles();
        System.out.println("After get articles");
